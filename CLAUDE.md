...
CI enforces a 75% total coverage floor (`go test -race -coverprofile=coverage.out -covermode=atomic ./...`). The floor is a ratchet: raise it as coverage improves, never lower it.
